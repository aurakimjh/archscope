...
and measurement-unit contracts were resolved on 2026-07-20 (T-558, T-559), and
the desktop integration path was resolved the same day (T-560, option A path
unification with a staged rollout), so Phase 1 parsing, Phase 2 classification,
and Phase 4 desktop integration may start; Phase 3 stays gated on T-561.
