...
time-window overlay. T-583 remains `IN_PROGRESS` only for the X-RG1 group
review.
**T-586 is complete**:
...
|---:|---|---|---|---|
| 1 | T-583 | P1 | `IN_PROGRESS` | Backend, generated bindings, and Claude drilldown/overlay UI complete (2026-07-31); run the X-RG1 group review |
...
- Release baseline: `v0.3.5` is the latest stable GitHub release. The
  ...
  release candidate.
- Current execution focus: T-583 / X-RG1 backend, regenerated Wails
  bindings, and the Claude drilldown/overlay UI are complete with bounded
  HTTP/profile/Jennifer/access-log correlation, fail-closed clock alignment,
  confidence/provenance diagnostics, and no-causality output; the X-RG1
  group review remains. T-582 /
...
1. **IN_PROGRESS — T-583 / X-RG1 HTTP/profile/server-evidence correlation:**
   ...
   aligned-only time-window overlay, and full state regressions. Next: run
   the X-RG1 group review. Obligations carried forward: the isolated
...
| 7 | X-RG1 HTTP/profile/server-evidence correlation | Codex engine, Claude UI | IN PROGRESS — Codex backend complete; bindings/UI/review remain | Group PASS |
...
| T-583 | P1 | IN_PROGRESS | Implement and review X-RG1 HTTP correlation with Chrome/V8 CPU runs, Jennifer network-gap evidence, and access logs, including bounded alignment/confidence diagnostics and provenance-aware UI drilldown/overlay. | T-582 PASS (2026-07-30) | Codex backend, regenerated bindings, and Claude drilldown/overlay UI complete 2026-07-31; the X-RG1 group review remains. Incompatible clocks fail closed and no surface claims causality |
