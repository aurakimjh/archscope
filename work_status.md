...
| T-351 | P1 | [ ] | 5 — web server | Static React mount via `embed.FS` — same wheel-packaging contract as Python (T-208), so the Go build also ships `apps/frontend/dist` embedded. | T-350 | Embedded UI bundle |
