...
**T-584 / R-RG1 backend/platform acceptance is review-ready as of 2026-07-31**:
...
parallel CI run `30601745284` passed as well. Only the independent R-RG1 verdict
remains required; no UI source, tag, or release was changed.
**T-586 is complete**:
...
|---:|---|---|---|---|
| 1 | T-584 | P0 | `REVIEW` | All local and pushed platform gates pass; request independent R-RG1 review |
...
- Current execution focus: T-584 / R-RG1 final integrated release acceptance.
  The backend acceptance handoff and pushed platform gates pass. Native
  Windows resolver cost is recorded from 50/50 confirmed samples; the
  independent R-RG1 review is the remaining gate.
...
1. **REVIEW — T-584 / R-RG1 integrated release acceptance:**
   ...
   and maximum 0.857 ms. Next, obtain an independent R-RG1 `PASS`. Do not
...
| 8 | R-RG1 integrated release acceptance | Codex + Claude + independent reviewer | REVIEW — local/platform gates pass; independent verdict pending | Release PASS |
...
| T-584 | P0 | REVIEW | Run R-RG1 integrated release acceptance across Go test/vet/build, frontend test/build, Windows live E2E, macOS offline import/package smoke, paired documentation, support/security/performance matrices, and honest release notes. | T-583 PASS (2026-07-31) | Backend/platform acceptance passed locally and in Actions run `30601745253`; Windows live E2E passed and resolver evidence confirmed 50/50 samples (mean 0.539 ms, p95 0.731 ms, max 0.857 ms). Obtain independent R-RG1 `PASS`; no tag or release first |
