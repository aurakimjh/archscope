...
class BreakdownTopItem(TypedDict):
    name: str
    samples: int


class ExecutionBreakdownRow(TypedDict):
    category: str
    executive_label: str
...
class FlameNodeContract(TypedDict):
    ...
    category: str | None
    color: str | None
    children: list["FlameNodeContract"]
    path: list[str]
...
class TopChildFrameRow(TypedDict):
    frame: str
    samples: int
    ratio: float
