...
| Browser audits | `browser_audit_evidence` | `browser import` | Lighthouse report JSON (`lighthouse-json`), with report-score preservation, Core Web Vitals/audit/resource projections, URL redaction, and bounded tables |
