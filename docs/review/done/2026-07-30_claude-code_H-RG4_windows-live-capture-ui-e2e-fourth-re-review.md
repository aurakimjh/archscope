...
| `sha256sum` of the replaced artifact | Repository LF-normalized bytes: `2737133818ee1881cfb6ee73f622e1ca6137b63b1818ee699a7eae5fc7218c7e`; original Windows CRLF bytes reviewed here: `69565684d57b20d763ed477f731a9eb836bcc8fbde657cdff10bce0085030111`. The LF pin and provenance note were corrected during R-RG1 on 2026-08-03. |
...
| V2 | L | **Resolved** | Both plans record the artifact lifecycle truthfully: EN §1/§8/§H-RG4 and KO §1/§8/§H-RG4 describe the first artifact as rejected by V1 and the replacement as archived. The R-RG1 correction records the LF-normalized repository checksum `27371338…7218c7e` and preserves the original Windows CRLF checksum `69565684…0111`; the "no inspectable Windows artifact exists" text is gone from both languages. `work_status.md` and the plans agree. |
