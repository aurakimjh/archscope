...
- 현재 구현 상태: `stitch analyze`는 기존 result JSON 파일에서 match group,
  gap finding, Incident Timeline row, stitched Service Flow dependency를 담은
  `stitched_evidence`를 생성한다.
