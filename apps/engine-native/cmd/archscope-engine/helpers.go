...
func writeJSONAny(payload any, out string) error {
	return writeJSONAnyMode(payload, out, 0o644)
}

func writePrivateJSONAny(payload any, out string) error {
	return writeJSONAnyMode(payload, out, 0o600)
}

func writeJSONAnyMode(payload any, out string, mode os.FileMode) error {
